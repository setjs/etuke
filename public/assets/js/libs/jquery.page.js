;(function($){
    var methods = {
        ...
        pageData: function(_v, _current){
            ...
            if(opts.ajaxSetData&&(typeof(opts.ajaxSetData)==='boolean')){
                ...
                //if(opts.url!=='' && typeof(opts.url)==='string'){
                    ...
                    ishasDataRender ? opts.dataRender(opts) : methods.dataRender(_v, opts);
        ...
        addBtn: function(_property, _page, _count){
            ...
            return '<a class="'+_property+'" href="#page='+_page+'" '+disabled+'></a>';
        },
        ...
        ajaxData: function(_url, _current){
            ...
            var _data = $.fn.zPager.defaults.data;
            console.log(_total);
            return (function(){
