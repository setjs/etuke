    ...
    <div class="row">
        <div class="col-sm">
            <div class="input-group">
                <input type="text" name="captcha" placeholder="验证码" maxlength="4" class="form-control" required>
                <div class="input-group-append">
                    {{--<img src="{{ captcha_src() }}" class="captcha" width="120" height="36">--}}
                    <img class="pointer captcha" src="/service/create" id="v-code" width="120" height="36" onclick="this.src='/service/create?v=' + Math.random()">
                </div>
            </div>
        </div>
    </div>
...
<div class="form-group">
    ...
    <div class="row">
        <div class="col-sm">
            <div class="input-group">
                <input type="text" name="sms_captcha" placeholder="手机验证码" maxlength="4" class="form-control" required>
