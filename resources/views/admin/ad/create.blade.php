    ...
    <div class="row portlet light bordered cf">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-dark bold uppercase">添加广告</span>
            </div>
            <div class="actions">
            ...
            <form id="form">
                ...
                <div class="form-horizontal form-item">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" maxlength="20"  class="form-control" name="title" />
                        </div>
                    </div>
...
@section('script')
    ...
    <script>
        $('#submit-form').click(function(){
            ...
            APP.ajax({'url':'{{ route('ad.create')}}'},'#form',function(r){
                if(r.code == 0){
