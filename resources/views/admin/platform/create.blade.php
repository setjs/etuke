    ...
    <div class="row portlet light bordered cf">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-dark bold uppercase">创建平台</span>
            </div>
            <div class="actions">
            ...
            <form id="form">
                ...
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            @include('components.backend.editor', ['name' => 'text'])
                        </div>
                    </div>


                    @include('components.backend.image', ['name' => 'thumb', 'title' => 'logo' , 'value'=>''])
...
@section('script')
    <script>
        $('#submit-form').click(function(){
            APP.ajax({'url':"{{ route('post.platform.create') }}"},'#form',function(r){
              if(r.code == 500){
                  console.log(r);
                // alert('请填检查相应的数据');
