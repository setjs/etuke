    ...
    <div class="row portlet light bordered cf">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-dark bold uppercase">课程</span>
            </div>
            <div class="actions">
                <div class="btn-group btn-group-devided">
                    <a href="/course/create" class="btn btn-primary ml-auto">添加</a>
                </div>
            </div>
        </div>
                ...
                <table class="table table-hover">
                    ...
                    @forelse($courses as $course)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('course.edit', $course)}}" class="btn btn-warning btn-sm">编辑</a>
                                @include('components.backend.destroy', ['url' => route('course.destroy', $course)])
                                <a href="{{route('coursechapter.index', $course->id)}}" class="btn btn-info btn-sm">章节</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
