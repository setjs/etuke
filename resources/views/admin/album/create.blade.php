    ...
    <div class="row portlet light bordered cf">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-dark bold uppercase">创建专辑</span>
            </div>
            <div class="actions">
            ...
            <form id="form">
                ...
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            @include('components.backend.editor', ['name' => 'desc'])
                        </div>
                    </div>
...
@section('script')
    <script>
        $('#submit-form').click(function(){
            APP.ajax({'url':"{{ route('post.album.create') }}"},'#form',function(r){
              if(r.code == 500){
                  console.log(r);
                // alert('请填检查相应的数据');
