...
class Generator
{
    ...
    {
        $viewPath = app_path('Tool/AutoTool/template/request.template');
    ...
    {
        $viewPath = app_path('Tool/AutoTool/template/controller.template');
        $viewContent = file_get_contents($viewPath);
    ...
    {
        $viewPath = app_path('Tool/AutoTool/template/router.template');
        $viewContent = file_get_contents($viewPath);
    ...
    {
        $viewPath = app_path('Tool/AutoTool/template/create.template');
        $viewContent = file_get_contents($viewPath);
...
EOF;
    ...
    {
        $viewPath = app_path('Tool/AutoTool/template/edit.template');
        $viewContent = file_get_contents($viewPath);
...
EOF;
    ...
    {
        $viewPath = app_path('Tool/AutoTool/template/index.template');
        $viewContent = file_get_contents($viewPath);
